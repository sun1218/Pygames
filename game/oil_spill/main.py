...
from game.oil_spill.library import *

darktan = 190, 190, 110, 255
tan = 210, 210, 130, 255


class OilSprite(Sprite):
    def __init__(self):
    ...
    def update(self, timing, rate=30):
        Sprite.update(self, timing, rate)
...
while True:
    ...
    if oil_hit:
        print_text(font, screen, 0, 0, "OIL SPLOTCH - CLEAN IT!")
    else:
        print_text(font, screen, 0, 0, "CLEAN")
